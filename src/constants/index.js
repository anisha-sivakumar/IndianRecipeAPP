import {
  ...
  const experiences = [
    {
  title: "Intelligent Indian Recipe Generator",
  company_name: "Team Project",
  icon: reactjs,
  iconBg: "#E6DEDD",
  date: "February 2025",
  points: [
    "Working on a MERN stack application to generate personalized Indian recipes based on user inputs such as ingredients, cuisine, quantity, and course type.",
    "Developed the backend using Node.js and Express, connected to MongoDB to store and query over 200K recipes from a curated dataset.",
    "Implemented a React frontend for searching and displaying recipes, with dynamic filters and real-time API integration.",
  ],
  Etags: [
    {
      name: "React.js",
